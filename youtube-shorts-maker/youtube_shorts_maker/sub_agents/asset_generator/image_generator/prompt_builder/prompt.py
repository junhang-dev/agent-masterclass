PROMPT_BUILDER_DESCRIPTION = (
    ...
    "and optimizes prompts for GPT-Image-1-mini model. Outputs array of optimized vertical image generation prompts."
)
...
4. **Optimize for GPT-Image-1-mini model** with appropriate style and quality keywords
