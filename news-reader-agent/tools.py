...
def scrape_tool(url: str):
    ...
    try:
        ...
        unwanted_tags = [
            ...
            "textarea", "img", "svg", "canvas", "audio", "video",
            "embed", "object"
        ]
        ...
        return content if content else f"Scraped the site {url}, but found no textual content."
    except Exception as e:
        print(f"Error scraping URL {url}: {e}")
        return f"Failed to scrape the URL: {url}. Error: {e}"